package com.xzx.hf.prisonattendance.baidu.utils;
...
//                ARGBImg argbImg = getData(context, mPicName + 0 + ".png");
                ARGBImg argbImg = getData(context, "pic/test" + ".jpg");
...
//        }).start();
    ...
    private void startFaceWorkSingle(int index, ARGBImg argbImg) {
        ...
        if (faces != null && faces.length > 0) {
            ...
            float[] faceT = new float[]{faces[maxId].mCenter_x, faces[maxId].mCenter_y,
                    faces[maxId].mWidth, faces[maxId].mAngle};
